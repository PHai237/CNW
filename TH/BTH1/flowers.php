...
$flowers = [
    ...
    "img" => "imgs/denlong.webp"],
    ["name" => "6. Hoa cẩm chướng",
    ...
    "img" => "imgs/camchuong.webp"],
    ["name" => "7. Hoa huỳnh anh",
